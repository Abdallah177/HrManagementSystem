...
using HrManagementSystem.Features.BranchManagement.Common.Queries.CheckBranchExists;
using HrManagementSystem.Features.DepartmentManagement.Common.Queries;
using Mapster;
using MediatR;

namespace HrManagementSystem.Features.DepartmentManagement.Commands.AddDepartment.Commands
{
