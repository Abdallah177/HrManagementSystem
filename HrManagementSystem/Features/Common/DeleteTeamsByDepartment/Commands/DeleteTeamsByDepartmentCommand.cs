...
namespace HrManagementSystem.Features.Common.DeleteTeamsByDepartment.Commands
{
    public record DeleteTeamsByDepartmentCommand(string departmentId , string currentUserId) : IRequest<RequestResult<bool>>;

    public class DeleteTeamsByDepartmentCommandHandler : RequestHandlerBase<DeleteTeamsByDepartmentCommand, RequestResult<bool>, Team>
    {
        public DeleteTeamsByDepartmentCommandHandler(RequestHandlerBaseParameters<Team> parameters) : base(parameters)
        {
        }
