...
namespace HrManagementSystem.Features.Common.DeleteDepartmentsByBranch.Commands
{
    public record DeleteDepartmentsByBranchCommand(string branchId , string currentUserId): IRequest<RequestResult<bool>>;

    public class DeleteDepartmentsByBranchCommandHandler : RequestHandlerBase<DeleteDepartmentsByBranchCommand, RequestResult<bool>, Department>
    {
        public DeleteDepartmentsByBranchCommandHandler(RequestHandlerBaseParameters<Department> parameters) : base(parameters)
        {
        }
